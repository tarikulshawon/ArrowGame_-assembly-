...
balloonX db 15  ; max value of col is 80
balloonY db 30  ; max value of row is 29
color db 181
msg_color db 9 ;background color
...
_10:
     mov temp,'1'
     display_string temp,12,63,1 
     mov ch,target
     sub ch,10
     mov temp,ch
     display_string temp,12,64,1 
     jmp end__
_20:
     mov temp,'2'
     display_string temp,12,63,1 
...
over:    
    ...
    ;draw again to vanish
    CALL draw_character
    CALL draw_balloon
   ; mov msg_color,0
   ; call display_msg_score
    ; display game over
   ; mov msg_color ,9
   display_string msg_gameover 10,25,9
    
    
    
not_over:    
    ret 
game_over_check endp

display_msg_score proc near
    
    display_string msg_missed,5,63,12
    display_string msg_score,10,63,5
    
    ret
    display_msg_score endp 
